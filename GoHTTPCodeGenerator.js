...
(function() {
  var GoHTTPCodeGenerator, addslashes;
  ...
  GoHTTPCodeGenerator.identifier = "com.luckymarmot.PawExtensions.GoHTTPCodeGenerator";

  GoHTTPCodeGenerator.title = "Go (HTTP)";
